...
class Dailian:
    ...
    def url_list(self):
        ...
        for i in range(len(cate_values)):
            ...
            for k in range(len(sub_key)):
                ...
                url_list = 'https://dailian.co.kr/newslist?category2=' + f'{subvalue_list}'
    ...
    def crawler(self, news, cate_key, cate_values, subkey_list, subval_list) -> dict:
        ...
        dailian_list['content_url'] = 'https://www.dailian.co.kr' + href
        dailian_list['naver_link'] = dailian_list['content_url'] + '?sc=Naver'
        sleep(3)

        ## body_raw
        body_res = requests.get(dailian_list['content_url'], headers=self.harder)
